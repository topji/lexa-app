...
async function main() {
    if (process.argv.length < 4) {
        ...
        console.error("Example: npx ts-node examples/get-report-by-timestamp.ts 0x000359843a543ee2fe414dc14c7e7920ef10f4372990b79d6361cdc0dd1ba782 1754604071");
        console.error(`Current timestamp: ${(0, time_1.getCurrentTimestamp)()}`);
        console.error("Note: The timestamp must be within the last 30 days.");
        process.exit(1);
    }
    const feedId = process.argv[2];
    const timestamp = parseInt(process.argv[3]);
    const version = (0, report_1.getReportVersion)(feedId);
    try {
        const config = {
        ...
        const client = (0, src_1.createClient)(config);
        ...
        // Decode the report
        const decodedData = (0, src_1.decodeReport)(report.fullReport, report.feedID);
...
main();
//# sourceMappingURL=get-report-by-timestamp.js.map