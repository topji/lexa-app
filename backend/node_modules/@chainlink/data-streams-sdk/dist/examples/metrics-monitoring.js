...
exports.assessStreamReliability = assessStreamReliability;
...
async function monitoringExample() {
    ...
    stream.on("report", report => {
        ...
        const price = decodedReport.price ||
            decodedReport.benchmarkPrice ||
            "N/A";
        ...
        console.log(`📈 Reports: ${metrics.accepted} unique, ${metrics.deduplicated} duplicates (${deduplicationRate}% dedup rate)`);
...
function getStatusIcon(status) {
    switch (status) {
        case src_1.ConnectionStatus.CONNECTED:
            return "🟢";
        case src_1.ConnectionStatus.CONNECTING:
            return "🟡";
        case src_1.ConnectionStatus.RECONNECTING:
            return "🟠";
        case src_1.ConnectionStatus.FAILED:
            return "🔴";
        case src_1.ConnectionStatus.DISCONNECTED:
        default:
            return "⚫";
    }
}
 ...
 */
function assessStreamReliability(metrics) {
    const reliability = {
...
//# sourceMappingURL=metrics-monitoring.js.map