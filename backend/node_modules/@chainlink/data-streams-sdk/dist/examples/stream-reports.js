...
const report_1 = require("../src/utils/report");
...
async function main() {
    if (process.argv.length < 3) {
        ...
        console.error("    npx ts-node examples/stream-reports.ts 0x000359843a543ee2fe414dc14c7e7920ef10f4372990b79d6361cdc0dd1ba782");
        console.error("  Multiple feeds:");
        console.error("    npx ts-node examples/stream-reports.ts 0x000359843a543ee2fe414dc14c7e7920ef10f4372990b79d6361cdc0dd1ba782,0x00036fe43f87884450b4c7e093cd5ed99cac6640d8c2000e6afc02c8838d0265");
    ...
    try {
        ...
        stream.on("report", report => {
            ...
            try {
                ...
                // Decode the report
                const decodedData = (0, decoder_1.decodeReport)(report.fullReport, report.feedID);
                const version = (0, report_1.getReportVersion)(report.feedID);
                ...
                console.log((0, report_1.formatReport)(decodedReport, version));
            }
            catch (error) {
        ...
        stream.on("reconnecting", (info) => {
            console.log(`🔄 Reconnecting... attempt ${info.attempt} in ~${info.delayMs}ms${info.host ? ` (${info.host})` : ""}`);
        });
...
main();
//# sourceMappingURL=stream-reports.js.map