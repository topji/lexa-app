...
exports.decodeReport = decodeReport;
const ethers_1 = require("ethers");
const errors_1 = require("../types/errors");
const types_1 = require("../types");
const globalAbiCoder = new ethers_1.AbiCoder();
const outerReportAbiCoder = new ethers_1.AbiCoder();
 ...
 */
function decodeReport(reportHex, feedId, logger) {
    ...
    try {
        ...
        switch (version) {
            ...
            default:
                throw new errors_1.ReportDecodingError(`Unknown report version: 0x${version}`);
        }
    }
    catch (error) {
        if (error instanceof errors_1.ReportDecodingError) {
            throw error;
        }
        throw new errors_1.ReportDecodingError(`Failed to decode report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV2Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V2 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV3Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V3 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV4Report(reportBlob) {
    try {
        ...
        if (marketStatus !== types_1.MarketStatus.UNKNOWN &&
            marketStatus !== types_1.MarketStatus.INACTIVE &&
            marketStatus !== types_1.MarketStatus.ACTIVE) {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V4 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV5Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V5 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV6Report(reportBlob) {
    try {
        ...
        return {
            ...
            price4: decoded[9],
            price5: decoded[10],
        }; // price fields are bigint
    }
    catch (error) {
        throw new errors_1.ReportDecodingError(`Failed to decode V6 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV7Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V7 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV8Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V8 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV9Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V9 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV10Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V10 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV11Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V11 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV12Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V12 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
function decodeV13Report(reportBlob) {
    try {
        ...
        throw new errors_1.ReportDecodingError(`Failed to decode V13 report: ${error instanceof Error ? error.message : String(error)}`);
    }
}
