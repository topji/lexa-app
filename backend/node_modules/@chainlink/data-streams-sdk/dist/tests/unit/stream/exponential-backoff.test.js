...
describe("Exponential Backoff Reconnection", () => {
    ...
    beforeEach(() => {
        ...
        connectionManager = new connection_manager_1.ConnectionManager(mockConfig, managerConfig);
    });
    afterEach(() => {
    ...
    test("should cap delay at maximum reconnect interval", async () => {
        ...
        const maxDelay = constants_1.WS_CONSTANTS.MAX_RECONNECT_INTERVAL; // 10000ms
    ...
    test("should never go below minimum delay", async () => {
        ...
        const minDelay = constants_1.WS_CONSTANTS.RECONNECT_DELAY;
    ...
    test("should use configured reconnectInterval as base delay", async () => {
        ...
        const cm = new connection_manager_1.ConnectionManager({
            apiKey: "test-key",
            userSecret: "test-secret",
            endpoint: "https://test.example.com",
        ...
        cm.scheduleReconnection(mockConnection);
    ...
    test("should respect reconnectInterval", async () => {
        ...
        const smallBase = 50;
        const cmMin = new connection_manager_1.ConnectionManager({
            apiKey: "test-key",
            userSecret: "test-secret",
            endpoint: "https://test.example.com",
            wsEndpoint: "wss://test1.example.com",
        ...
        cmMin.scheduleReconnection(connMin);
        ...
        const cmMax = new connection_manager_1.ConnectionManager({
            apiKey: "test-key",
            userSecret: "test-secret",
            endpoint: "https://test.example.com",
            wsEndpoint: "wss://test1.example.com",
        ...
        cmMax.scheduleReconnection(connMax);
        ...
        expect(maxDelayObserved).toBe(constants_1.WS_CONSTANTS.MAX_RECONNECT_INTERVAL);
    });
});
//# sourceMappingURL=exponential-backoff.test.js.map