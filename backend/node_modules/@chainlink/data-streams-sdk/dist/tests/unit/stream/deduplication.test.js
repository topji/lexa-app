...
const deduplication_1 = require("../../../src/stream/deduplication");
describe("ReportDeduplicator", () => {
    let deduplicator;
    beforeEach(() => {
        deduplicator = new deduplication_1.ReportDeduplicator();
    });
    afterEach(() => {
        deduplicator.stop();
    });
    ...
    describe("cleanup functionality", () => {
        it("should initialize with cleanup enabled", () => {
            const dedup = new deduplication_1.ReportDeduplicator({
