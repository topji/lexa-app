...
describe("ConnectionManager", () => {
    ...
    describe("basic functionality", () => {
        it("should create instance and get initial connection counts", () => {
            const connectionManager = new connection_manager_1.ConnectionManager(mockConfig, mockManagerConfig);
        ...
        it("should initialize with multiple origins in HA mode", async () => {
            ...
            originDiscovery.getAvailableOrigins.mockResolvedValue(mockOrigins);
        ...
        it("should handle origin discovery failure", async () => {
            const connectionManager = new connection_manager_1.ConnectionManager(mockConfig, mockManagerConfig);
            originDiscovery.getAvailableOrigins.mockRejectedValue(new Error("Discovery failed"));
    ...
    describe("connection status", () => {
        ...
        it("should handle status callbacks", async () => {
            ...
            const connectionManager = new connection_manager_1.ConnectionManager(mockConfig, configWithCallback);
            const mockOrigins = ["wss://origin1.example.com"];
            originDiscovery.getAvailableOrigins.mockResolvedValue(mockOrigins);
            mockWebSocket.on.mockImplementation((event, callback) => {
                if (event === "open") {
