...
const logger_2 = require("../../../src/types/logger");
const src_1 = require("../../../src");
describe("SDKLogger", () => {
    describe("Unit Tests", () => {
        it("should be silent by default", () => {
            const logger = new logger_1.SDKLogger();
        ...
        it("should respect log level filtering", () => {
            ...
            const logger = new logger_1.SDKLogger({
                logger: mockLogger,
                logLevel: logger_2.LogLevel.INFO,
            });
        ...
        it("should handle all log levels correctly", () => {
            ...
            const logger = new logger_1.SDKLogger({
                logger: mockLogger,
                logLevel: logger_2.LogLevel.DEBUG, // Allow all levels
            });
            logger.debug("debug message");
        ...
        it("should handle connection debug logs", () => {
            ...
            const logger = new logger_1.SDKLogger({
                logger: mockLogger,
                logLevel: logger_2.LogLevel.DEBUG, // Enable DEBUG level
        ...
        it("should handle logger errors gracefully", () => {
            ...
            const logger = new logger_1.SDKLogger({ logger: faultyLogger });
            // Should not throw despite logger error
            expect(() => logger.info("test")).not.toThrow();
        });
        it("should format messages with timestamp and prefix", () => {
            const mockLogger = { info: jest.fn() };
            const logger = new logger_1.SDKLogger({ logger: mockLogger });
            logger.info("test message");
            expect(mockLogger.info).toHaveBeenCalledWith(expect.stringMatching(/^\[[\d-T:.Z]+\] \[DataStreams\] test message$/));
        });
        it("should pass additional arguments to logger", () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith(expect.stringMatching(/\[.*\] \[DataStreams\] Error occurred/), error, extraData);
        });
        it("should handle missing logger methods gracefully", () => {
            const incompleteLogger = { info: jest.fn() }; // Missing debug, warn, error
            const logger = new logger_1.SDKLogger({ logger: incompleteLogger });
        ...
        it("should have zero overhead when logging disabled", () => {
            ...
            const logger = new logger_1.SDKLogger(); // No config = disabled
    ...
    describe("Integration Tests", () => {
        ...
        it("should validate logging config correctly", () => {
            ...
            expect(() => (0, src_1.createClient)({
                ...
                wsEndpoint: "wss://test.example.com",
                logging: {
                    enableConnectionDebug: "not a boolean",
                },
        ...
        it("should handle stream logging integration", async () => {
            ...
            const client = (0, src_1.createClient)({
                ...
                logging: {
                    logger: mockLogger,
                    logLevel: logger_2.LogLevel.DEBUG,
                },
            });
        ...
        it("should handle different log levels in production scenario", async () => {
            ...
            const clientInfo = (0, src_1.createClient)({
                apiKey: "test",
                userSecret: "test",
                endpoint: "https://test.example.com",
                wsEndpoint: "wss://test.example.com",
            ...
            logs.length = 0;
            const errorLogger = new logger_1.SDKLogger({
                logger: productionLogger,
                logLevel: logger_2.LogLevel.ERROR,
            });
